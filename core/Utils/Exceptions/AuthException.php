 ...
 */
class AuthException extends \Core\Utils\Exceptions\Contract\CoreException
{
    /**
    ...
    public function __construct(
        string $message = 'You are unauthenticated.',
        int $error_code = ErrorCodeEnum::AUTHENTICATION_FAILED,
        int $status_code =  Response::HTTP_UNAUTHORIZED,
        $error = null,
        int $code = 0,
