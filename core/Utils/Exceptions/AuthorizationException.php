 ...
 */
class AuthorizationException extends \Core\Utils\Exceptions\Contract\CoreException
{
    /**
    ...
    public function __construct(
        string $message = 'You are not authorize to execute this action.',
        int $error_code = ErrorCodeEnum::AUTHORIZATION_FAILED,
