...
namespace Domains\Finances\EcrituresAnalytique\DataTransfertObjects;
...
/**
 * Class ***`CreateEcritureAnalytiqueDTO`***
 *
 * This class extends the ***`BaseDTO`*** class.
 * It represents the data transfer object for creating a new ***`EcritureAnalytique`*** model.
 *
 * @package ***`\Domains\Finances\EcrituresAnalytique\DataTransfertObjects`***
 */
class CreateEcritureAnalytiqueDTO extends BaseDTO
{
    /**
     * @var
     */
