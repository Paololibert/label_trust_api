...
class UpdateDeviseDTO extends BaseDTO
{
    ...
    {
        $rules = array_merge([
            "name"            		=> ["string", "required", "max:25", 'unique_ignore_case:devises,name,' . request()->route("devise_id") . ',id'],
            "symbol"            	=> ["string", "required", "max:25", 'unique_ignore_case:devises,symbol,' . request()->route("devise_id") . ',id'],
