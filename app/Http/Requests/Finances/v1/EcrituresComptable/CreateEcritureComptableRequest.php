...
/**
 * Class **`CreateEcritureComptableRequest`**
 *
 ...
 */
class CreateEcritureComptableRequest extends CreateResourceRequest
{

    public function __construct(){
        parent::__construct(CreateEcritureComptableDTO::fromRequest(request()));
    }
