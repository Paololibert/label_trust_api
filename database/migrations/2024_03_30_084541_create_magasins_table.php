...
/**
 * Class ***`CreateMagasinsTable`***
 *
 * A migration class for creating the "magasins" table with UUID primary key and timestamps.
 *
 * @package ***`\Database\Migrations\CreateMagasinsTable`***
 */
class CreateMagasinsTable extends Migration
{
    ...
    public function up(): void
    {
        ...
        try {
            ...
            Schema::create('magasins', function (Blueprint $table) {
                ...
                // Define a UUID primary key for the 'magasins' table
                $this->uuidPrimaryKey($table);
                
                // Define a unique string column for the magasin name
                $table->string('name')->unique()->comment('The unique name of the magasin');
                
                // Define a string column for the magasin address
                $table->string('address')->comment('The address of the magasin');
            ...
            throw new \Core\Utils\Exceptions\DatabaseMigrationException(
                message: 'Failed to migrate "magasins" table: ' . $exception->getMessage(),
                previous: $exception
            );
        }
    }
    ...
    public function down(): void
    {
        ...
        try {
            ...
            // Drop the "magasins" table if it exists
            ...
            // Handle the exception (e.g., logging, notification, etc.)
            throw new \Core\Utils\Exceptions\DatabaseMigrationException(
                message: 'Failed to drop "magasins" table: ' . $exception->getMessage(),
                previous: $exception
            );
        }
    }
